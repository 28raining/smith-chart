        ...
        <AccordionDetails>
          ...
          >
            ...
            <TableBody>
              ...
              <TableRow>
                <TableCell>
                  <Typography>.s2p gain equations</Typography>
                </TableCell>
                <TableCell>
                  <math xmlns="http://www.w3.org/1998/Math/MathML" display="block">
                    <msub>
                ...
                <TableCell>
                  <Typography>
                    Cross checked{" "}
                    <a href="https://www.allaboutcircuits.com/technical-articles/designing-a-unilateral-rf-amplifier-for-a-specified-gain">here</a>
                  </Typography>
                  Cs and Rl are reflection coefficients so have to be translated to impedance using Z = Z0 * (1 + Γ) / (1 - Γ)
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
              ...
              <TableRow>
                <TableCell>
                  <Typography>Stability Circles</Typography>
                </TableCell>
                <TableCell>
                  <math xmlns="http://www.w3.org/1998/Math/MathML" display="block">
                    <msub>
                ...
                <TableCell>
                  <Typography>
                    Cross checked{" "}
                    <a href="https://www.allaboutcircuits.com/technical-articles/learn-about-unconditional-stability-and-potential-instability-in-rf-amplifier-design/">
                      here
                    </a>
                  </Typography>
                </TableCell>
