...
export const circuitComponents = {
  blackBox: {
    ...
    fromURL: (u) => {return {'name':u[0],'real':Number(u[1]), 'imaginary':Number(u[2]), 'tolerance':Number(u[3])}}
  },
  shortedCap: {
    ...
    fromURL: (u) => {return {'name':u[0],'value':Number(u[1]), 'unit':u[2], 'tolerance':Number(u[3]), 'esr':Number(u[4]), 'esl':Number(u[5])}}
  },
  seriesCap: {
  ...
  shortedInd: {
    ...
    fromURL: (u) => {return {'name':u[0],'value':Number(u[1]), 'unit':u[2], 'tolerance':Number(u[3]), 'esr':Number(u[4])}}
  ...
  shortedRes: {
    ...
    fromURL: (u) => {return {'name':u[0],'value':Number(u[1]), 'unit':u[2], 'tolerance':Number(u[3]), 'esl':Number(u[4])}}
  ...
  seriesRlc: {
    ...
    fromURL: (u) => {return {'name':u[0],'value':Number(u[1]), 'unit':u[2],'value_l':Number(u[3]), 'unit_l':u[4],'value_c':Number(u[5]), 'unit_c':u[6]}}
  ...
  custom: {
    ...
    fromURL: (u) => {return {'name':u[0],'interpolation':u[1], 'value':JSON.parse(u[2])}}
  ...
  transmissionLine: {
    ...
    fromURL: (u) => {return {'name':u[0],'value':Number(u[1]), 'unit':u[2], 'tolerance':Number(u[3]),'zo':Number(u[4]), 'eeff':Number(u[5])}}
  ...
  transformer: {
    ...
    fromURL: (u) => {return {'name':u[0],'l1':Number(u[1]), 'unit_l1':u[2],'l2':Number(u[3]), 'unit_l2':u[4], 'k':Number(u[5])}}
